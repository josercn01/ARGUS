...
export function LoginScreen() {
  ...
  return (
    <div className="min-h-screen bg-[#00121E] flex flex-col items-center justify-center text-white p-4">
      <div className="w-full max-w-sm p-8 rounded-2xl bg-[#001A2E] border border-[#D4AF37]/20">
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-[#D4AF37] text-black font-bold rounded-xl hover:bg-[#C4A137]"
        >
